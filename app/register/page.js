...
export default function RegisterPage() {
  ...
  return (
    <div className="form-container" style={{ maxWidth: '450px', margin: '40px auto' }}>
      <h1 style={{ textAlign: 'center', marginBottom: '30px' }}>Create Oak Ledger Account</h1>
      ...
      <div className="card" style={{ marginTop: '30px', backgroundColor: 'var(--bg-secondary)' }}>
        <h3 style={{ fontSize: '16px', marginBottom: '10px' }}>📚 About Double-Entry Bookkeeping</h3>
